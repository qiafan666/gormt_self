...
func showCmd() {
	...
	path := config.GetOutDir() + "/../gen/pojo/request/request.go"
	...
	path2 := config.GetOutDir() + "/../gen/pojo/response/response.go"
	...
	path3 := config.GetOutDir() + "/../gen/services/service.go"
	...
	path4 := config.GetOutDir() + "/../gen/controllers/controller.go"
