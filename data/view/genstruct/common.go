...
func (s *GenStruct) GeneratesService() []string {
	var p generate.PrintAtom
	p.Add(s.Name + "Create" + "(info request." + s.Name + "Create)(out response." + s.Name + "Create, err error)")
	p.Add(s.Name + "Delete" + "(info request." + s.Name + "Delete)(out response." + s.Name + "Delete, err error)")
	p.Add(s.Name + "Update" + "(info request." + s.Name + "Update)(out response." + s.Name + "Update, err error)")
	p.Add(s.Name + "List" + "(info request." + s.Name + "List)(out response." + s.Name + "List, err error)")
	p.Add("\n")
	return p.Generates()
}
func (s *GenStruct) GeneratesImpl() []string {
	...
	p.Add("// " + centerString("", "=", 80))
	p.Add("\n")
	p.Add("func (g *GenService) " + s.Name + "Create" + "(info request." + s.Name + "Create)(out response." + s.Name + "Create, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g *GenService) " + s.Name + "Delete" + "(info request." + s.Name + "Delete)(out response." + s.Name + "Delete, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g *GenService) " + s.Name + "Update" + "(info request." + s.Name + "Update)(out response." + s.Name + "Update, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g *GenService) " + s.Name + "List" + "(info request." + s.Name + "List)(out response." + s.Name + "List, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")
...
func (s *GenStruct) GeneratesController() []string {
	...
	p.Add("func (g " + "*GenController) " + s.Name + "Create(c *gin.Context) {")
	p.Add("\tinput := request." + s.Name + "Create{}")
	p.Add("\tif bindErr := function.BindAndValid(&input, c); bindErr != nil {")
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "iGenService." + s.Name + "Create(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
	p.Add("\t}")
	p.Add("}")
	p.Add("\n")
	...
	p.Add("func (g " + "*GenController) " + s.Name + "Delete(c *gin.Context) {")
	p.Add("\tinput := request." + s.Name + "Delete{}")
	p.Add("\tif bindErr := function.BindAndValid(&input, c); bindErr != nil {")
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "iGenService." + s.Name + "Delete(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
	...
	p.Add("func (g " + "*GenController) " + s.Name + "Update(c *gin.Context) {")
	p.Add("\tinput := request." + s.Name + "Update{}")
	p.Add("\tif bindErr := function.BindAndValid(&input, c); bindErr != nil {")
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "iGenService." + s.Name + "Update(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
	...
	p.Add("func (g " + "*GenController) " + s.Name + "List(c *gin.Context) {")
	p.Add("\tinput := request." + s.Name + "List{}")
	p.Add("\tif bindErr := function.BindAndValid(&input, c); bindErr != nil {")
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "iGenService." + s.Name + "List(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
...
func (p *GenPackage) GenerateServices() string {
	var pa generate.PrintAtom
	pa.Add("// Code generated by gormt_self. DO NOT EDIT.")
	pa.Add("package", "gen_services")
	// add import
	pa.Add("import (")
	pa.Add(")")

	pa.Add("\n")
	pa.Add("// " + "IGenService service layer interface")
	pa.Add("type", "IGenService", "interface {")
	for _, v := range p.Structs {
	...
	pa.Add("\n")
	pa.Add("type GenService struct {")
	pa.Add("	dao dao.IDao")
	pa.Add("}")
	pa.Add("\n")
	pa.Add("func NewGenService() IGenService {")
	pa.Add("	return &GenService{")
	pa.Add("		dao: dao.New(),")
	pa.Add("	}")
	pa.Add("}")
	// -----------end
...
func (p *GenPackage) GenerateControllers() string {
	var pa generate.PrintAtom
	pa.Add("// Code generated by gormt_self. DO NOT EDIT.")
	pa.Add("package", "gen_controllers")
	// add import
	pa.Add("import (")
	pa.Add("\"github.com/qiafan666/gotato/commons/ggin\"")
	pa.Add("\"github.com/gin-gonic/gin\"")
	pa.Add(")")
	pa.Add("\n")
	pa.Add("type GenController struct {")
	pa.Add("	iGenService services.IGenService")
	pa.Add("}")
	pa.Add("\n")
	pa.Add("func NewGenController() *GenController {")
	pa.Add("	return &GenController{")
	pa.Add("		iGenService: services.NewGenService(),")
	pa.Add("	}")
	pa.Add("}")
	pa.Add("\n")
