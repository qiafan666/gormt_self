...
func (s *GenStruct) GeneratesImpl() []string {
	...
	p.Add("// " + centerString("", "=", 80))
	p.Add("\n")
	p.Add("func (g genServiceImp) " + s.Name + "Create" + "(info request." + s.Name + "Create)(out response." + s.Name + "Create, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g genServiceImp) " + s.Name + "Delete" + "(info request." + s.Name + "Delete)(out response." + s.Name + "Delete, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g genServiceImp) " + s.Name + "Update" + "(info request." + s.Name + "Update)(out response." + s.Name + "Update, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")

	p.Add("func (g genServiceImp) " + s.Name + "List" + "(info request." + s.Name + "List)(out response." + s.Name + "List, err error) {")
	p.Add("\t//todo")
	p.Add("\treturn")
	p.Add("}")
...
func (s *GenStruct) GeneratesController() []string {
	...
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "genService." + s.Name + "Create(input); err != nil {")
	...
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "genService." + s.Name + "Delete(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
	...
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "genService." + s.Name + "Update(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
	...
	p.Add("\t\tggin.GinError(c, bindErr)")
	p.Add("\t} else {")
	p.Add("\t\tif out, err := g." + "genService." + s.Name + "List(input); err != nil {")
	p.Add("\t\t\tggin.GinError(c, err)")
	p.Add("\t\t} else {")
	p.Add("\t\t\tggin.GinSuccess(c, out)")
	p.Add("\t\t}")
